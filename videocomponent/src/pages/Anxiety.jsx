...
import Anxiety3 from './assets/pics/ANXIETY.png';
import Anxiety4 from './assets/pics/ANXIETY(1).png';
import Anxiety5 from './assets/pics/ANX(2).png';
import Anxiety6 from './assets/pics/ANX(3).png';
import Anxiety7 from './assets/pics/ANX(4).png';
        ...
        <div className="div">
          <div className="div">
            <ul className="list-disc pl-6 text-gray-700">
              ...
              <img src={Anxiety3} alt="img" className='image' style={{width:'85%'}} />
              ...
              <img src={Anxiety4} alt="img" className='image' style={{width:'85%'}} />
              ...
              <img src={Anxiety5} alt="img" className='image' style={{width:'85%'}} />
              ...
              <img src={Anxiety6} alt="img" className='image' style={{width:'85%'}} />
              ...
              <img src={Anxiety7} alt="img" className='image' style={{width:'85%'}} />
            </ul>
