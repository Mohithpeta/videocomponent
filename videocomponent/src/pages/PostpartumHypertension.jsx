...
const PostpartumHypertension = () => {
  return (
    <div >
      ...
      <p style={{fontSize:'25px',fontFamily:'cursive',justifyContent:'center'}}>
      ...
      <ul style={{fontSize:'25px',fontFamily:'cursive',justifyContent:'center'}}>
        <li>
      ...
      <h2 style={{fontSize:'35px',fontFamily:'cursive',justifyContent:'center',color:'#48aee9'}}>SCREENING</h2>
      <p style={{fontSize:'25px',fontFamily:'cursive',justifyContent:'center'}}>
      ...
      <h2 style={{fontSize:'35px',fontFamily:'cursive',justifyContent:'center',color:'#48aee9'}}>RISK FACTORS</h2>
      <img src={Hypertension1} alt='hypertension risk factors' className='image' />
      <h2 style={{fontSize:'35px',fontFamily:'cursive',justifyContent:'center',color:'#48aee9'}}>DIAGNOSIS</h2>
      <p style={{fontSize:'25px',fontFamily:'cursive',justifyContent:'center'}}>
      ...
      <h2 style={{fontSize:'35px',fontFamily:'cursive',justifyContent:'center',color:'#48aee9'}}>TREATMENT</h2>
      <p style={{fontSize:'25px',fontFamily:'cursive',justifyContent:'center'}}>
      ...
      <h2 style={{fontSize:'35px',fontFamily:'cursive',justifyContent:'center',color:'#48aee9'}}>CASE STUDIES</h2>
      <p style={{fontSize:'25px',fontFamily:'cursive',justifyContent:'center'}}>
      ...
      <h3 style={{fontSize:'25px',fontFamily:'cursive',justifyContent:'center'}}>STUDY IN HIGH-INCOME COUNTRIES</h3>
      <h4 style={{fontSize:'23px',fontFamily:'cursive',justifyContent:'center'}}>Telehealth with remote blood pressure monitoring for postpartum hypertension: A prospective single-cohort feasibility study</h4>
      <p style={{fontSize:'25px',fontFamily:'cursive',justifyContent:'center'}}>
      ...
      <h4 style={{fontSize:'25px',fontFamily:'cursive',justifyContent:'center'}}>Postpartum blood pressure self-management following hypertensive pregnancy: protocol of the Physician Optimised Post-partum Hypertension Treatment (POP-HT) trial</h4>
      <p style={{fontSize:'25px',fontFamily:'cursive',justifyContent:'center'}}>
      ...
      <h3 style={{fontSize:'25px',fontFamily:'cursive',justifyContent:'center'}}>STUDY IN MID-INCOME COUNTRIES</h3>
      <h4 style={{fontSize:'23px',fontFamily:'cursive',justifyContent:'center'}}>The incidence of pregnancy hypertension in India, Pakistan, Mozambique, and Nigeria: A prospective population-level analysis</h4>
      <p style={{fontSize:'25px',fontFamily:'cursive',justifyContent:'center'}}>
      ...
      <h3 style={{fontSize:'25px',fontFamily:'cursive',justifyContent:'center'}}>STUDY IN LOW-INCOME COUNTRY</h3>
      <h4 style={{fontSize:'23px',fontFamily:'cursive',justifyContent:'center'}}>Persistent Hypertension Up to One Year Postpartum among Women with Hypertensive Disorders in Pregnancy in a Low-Resource Setting: A Prospective Cohort Study</h4>
      <p style={{fontSize:'25px',fontFamily:'cursive',justifyContent:'center'}}>
      ...
      <h2 style={{fontSize:'35px',fontFamily:'cursive',justifyContent:'center',color:'#48aee9'}}>CONCLUSION</h2>
      <p style={{fontSize:'25px',fontFamily:'cursive',justifyContent:'center'}}>
      ...
      <h2 style={{fontSize:'35px',fontFamily:'cursive',justifyContent:'center',color:'#48aee9'}}>SPECIALISTS</h2>
      <p style={{fontSize:'25px',fontFamily:'cursive',justifyContent:'center'}}>An OB/GYN should be consulted for up to a year postpartum. If the condition continues, a cardiologist should be consulted.</p>
    </div>
  );
};
