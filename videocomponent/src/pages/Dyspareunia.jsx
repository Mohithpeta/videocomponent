  ...
  return (
    <div className="main">
      ...
      <section className="risk-factors" id='risk-factors'>
        <h2>RISK FACTORS ASSOCIATED WITH DYSPAREUNIA</h2>
      ...
      <section className="case-studies" id='case-studies'>
        ...
        <div className="study">
          ...
          <p><strong>Prevalence and Risk Factors for Dyspareunia and Unsatisfying Sexual Relationships in a Cohort o Primiparous and Secondiparous Women After 12 Months Postpartum</strong></p>
        </div>
        <div className="study">
